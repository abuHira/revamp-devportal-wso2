        ...
        <div class="authentication-wrapper authentication-basic container-p-y">
            <div class="authentication-inner">
                ...
                <div class="card">
                    <div class="card-body">
                        <!-- Logo -->
                        <a class="btn btn-primary btn-sm rounded" href="{{route('index')}}"><i class='bx bx-left-arrow-circle'></i> Landing Page</a>
                        <div class="app-brand justify-content-center">
                            <a href="#" class="app-brand-link gap-2">
                                <span class="app-brand-logo demo">
                                <img src="../assets/admin/img/favicon/icon-asabri.png" alt="" width="50">
                                </span>
                                <span class="app-brand-text demo text-body fw-bolder">ASABRI</span>
                            </a>
                        </div>
                        <!-- /Logo -->
                        <h4 class="mb-2">Welcome to ASABRI! 👋</h4>
                        <p class="mb-4">Please sign-in to your account and start the adventure</p>

                        <form id="formAuthentication" class="mb-3" action="{{route('authentication')}}" method="post">
                            @csrf

        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-9" data-aos="zoom-in-left">
                <div class="mb-3">
                    ...
                    <p class="fw-light p-2">Edit this application. Name and quota are mandatory parameters and
                        description is optional.</p>
                    <hr>
                </div>
                <div class="p-3">
                    <form action="{{route('update_app', $data->applicationId)}}" method="POST">
                        @csrf
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10  @error('appname') is-invalid @enderror">
                                <input type="text" class="form-control" name="appname" value="{{$data->name}}"
